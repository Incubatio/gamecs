    ...
    return BinaryHeap = (function() {
      ...
      */
      ...
      BinaryHeap.prototype.remove = function(node) {
        var isFound;
        return isFound = this.content.some(function(cNode, idx) {
          var end;
          if (cNode === node) {
            end = this.content.pop();
      ...
      */
      ...
      BinaryHeap.prototype.sinkDown = function(idx) {
        var element, parent, parentIdx, _results;
      ...
      */
      ...
      BinaryHeap.prototype.bubbleUp = function(idx) {
        var child1, child1Idx, child1Score, child2, child2Idx, child2Score, elemScore, element, length, swapIdx, _results;
