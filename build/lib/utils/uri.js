  ...
  define(function(require) {
    ...
    */
    ...
    return Uri = (function() {
      ...
      Uri.URI_REGEX = new RegExp('^' + '(?:' + '([^:/?#.]+)' + ':)?' + '(?://' + '(?:([^/?#]*)@)?' + '([\\w\\d\\-\\u0100-\\uffff.%]*)' + '(?::([0-9]+))?' + ')?' + '([^?#]+)?' + '(?:\\?([^#]*))?' + '(?:#(.*))?' + '$');
      ...
      */
      ...
      Uri.resolve = function(uri, path) {
        ...
        return host + this.removeDotSegments(absolutePath);
      };
      ...
      */
      ...
      Uri.match = function(uri) {
        return uri.match(this.URI_REGEX);
      };
      ...
      */
      ...
      Uri.makeRelative = function(uri) {
        var docLocPath;
        docLocPath = this.resolve(document.location.href, './');
