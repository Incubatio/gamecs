...
(function() {
  var CALLBACKS, CALLBACKS_LASTCALL, STARTTIME, TIMER_LASTCALL, fpsCallback, perInterval, reqAniFrameRecursive, reqAnimationFrame;
  ...
  */
  ...
  exports.interval = function(fn, fps, thisObj) {
    ...
    return fpsCallback(fn, thisObj, fps);
  };
  ...
  */
  ...
  fpsCallback = exports.fpsCallback = function(fn, thisObj, fps) {
    if (fps === void 0) {
      fps = 60;
    }
