    ...
    */
    ...
    return Worker = (function() {
      ...
      */
      ...
      Worker.inWorker = Worker.importScripts !== void 0;
      ...
      */
      ...
      Worker._ready = function() {
        self.onmessage = function(event) {
          return Key.post(event.data);
        };
      ...
      */
      ...
      Worker._messageMain = function(event) {
        return self.postMessage({
      ...
      */
      ...
      Worker.workerPrefix = function() {
        return __scripts.forEach(function(script) {
          try {
      ...
      */
      ...
      Worker.create = function(workerModuleId) {
      ...
      */
      ...
      Worker.prototype.post = function(data) {
        if (alive) {
      ...
      */
      ...
      Worker.prototype.guid = function(moduleId) {
        var S4;
        S4 = function() {
